...
def test_edit_submitted_assignment_student_2(client, h_student_1):
    response = client.post(
        '/student/assignments',
        headers=h_student_1,
        json={
...
def test_get_assignment_bad_student_id(client, h_bad_student):
    response = client.get(
        '/student/assignments',
